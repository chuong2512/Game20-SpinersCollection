...
public class IAPKey
{
    public const string PACK1 = "pack_spinner_collection_1";
    public const string PACK2 = "pack_spinner_collection_2";
    public const string PACK3 = "pack_spinner_collection_3";
    public const string PACK4 = "pack_spinner_collection_4";
    public const string PACK5 = "pack_spinner_collection_5";
    public const string PACK6 = "pack_spinner_collection_6";

    public const string PACK1_REGISTER = "pack_spinner_collection_register_1";
    public const string PACK2_REGISTER = "pack_spinner_collection_register_2";
    public const string PACK3_REGISTER = "pack_spinner_collection_register_3";
    public const string PACK4_REGISTER = "pack_spinner_collection_register_4";
    public const string PACK5_REGISTER = "pack_spinner_collection_register_5";
}
